...
class NeuralNetClassifier(object):
    ...
    def fit(self, data, targets):
        ...
        return NeuralNetModel(num_columns, num_hidden_layers, num_hidden_nodes, classes)

class NeuralNetModel(object):

    def __init__(self, num_columns, num_hidden_layers, num_hidden_nodes, classes):
        self.num_columns = num_columns
        self.num_hidden_layers = num_hidden_layers
        self.num_hidden_nodes = num_hidden_nodes
        self.network = Network(num_columns,num_hidden_layers,num_hidden_nodes, classes)
